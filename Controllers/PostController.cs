...
using CodeBrosForum.Models.Replies;
...
namespace CodeBrosForum.Controllers
{
    public class PostController : Controller
    {
        ...
        public async Task<IActionResult> EditPost(EditPostModel model)
        {
            ...
            {
                await _postService.EditPostTitle(model.Id, model.Title, lud, lun);
            }
            if (!(post.Content == model.Content))
            {
                await _postService.EditPostContent(model.Id, model.Content, lud, lun);
            }
